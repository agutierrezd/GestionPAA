...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("global_unspsc" == $this->chrt_array['tables'][0])
			return true;
		if("global_meses" == $this->chrt_array['tables'][0])
			return true;
		if("global_duracion" == $this->chrt_array['tables'][0])
			return true;
		if("global_modalidad" == $this->chrt_array['tables'][0])
			return true;
		if("global_fuenterec" == $this->chrt_array['tables'][0])
			return true;
		if("global_vf" == $this->chrt_array['tables'][0])
			return true;
		if("global_estvf" == $this->chrt_array['tables'][0])
			return true;
		if("global_ubicacion" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_usos" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_fuente" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_usos" == $this->chrt_array['tables'][0])
			return true;
		if("global_ejecucion_desagregada" == $this->chrt_array['tables'][0])
			return true;
		if("global_vigencia" == $this->chrt_array['tables'][0])
			return true;
		if("dependencia" == $this->chrt_array['tables'][0])
			return true;
		if("funcionario" == $this->chrt_array['tables'][0])
			return true;
		if("global_estado" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_vigencia" == $this->chrt_array['tables'][0])
			return true;
		if("cargo" == $this->chrt_array['tables'][0])
			return true;
		if("planta_tparam_tipo_nombramiento" == $this->chrt_array['tables'][0])
			return true;
		...
		if("contrato" == $this->chrt_array['tables'][0])
			return true;
		if("global_ejecucion_usos" == $this->chrt_array['tables'][0])
			return true;
		...
		if("tparam_tiporubro" == $this->chrt_array['tables'][0])
			return true;
		if("global_paa_nopaa" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_usos" == $this->chrt_array['tables'][0])
		...
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_pscdp" == $this->chrt_array['tables'][0])
			return true;
		if("global_operacion" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_pscdp" == $this->chrt_array['tables'][0])
			return true;
		if("global_estado_scdp" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_pscdp" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_modifica" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_modifica" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("global_estado_mod" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_usos" == $this->chrt_array['tables'][0])
		...
		if("paa_master_pscdp" == $this->chrt_array['tables'][0])
			return true;
		if("paa_master_ct" == $this->chrt_array['tables'][0])
			return true;
		if("dependencias_001" == $this->chrt_array['tables'][0])
			return true;
		if("gestionpaa_ver_103_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("q_list_uej" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
