...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("global_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	$projectEntities[ "paa_master_no_paa" ] = array( "url" => "paa_master_no_paa", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_no_paa" ] = "paa_master_no_paa";
	$projectEntities[ "paa_master_usos" ] = array( "url" => "paa_master_usos", "type" => 0 );
	$projectEntitiesReverse[ "paa_master_usos" ] = "paa_master_usos";
	$projectEntities[ "tparam_fuente" ] = array( "url" => "tparam_fuente", "type" => 0 );
	$projectEntitiesReverse[ "tparam_fuente" ] = "tparam_fuente";
	$projectEntities[ "q_group_rec" ] = array( "url" => "q_group_rec", "type" => 1 );
	$projectEntitiesReverse[ "q_group_rec" ] = "q_group_rec";
	...
	$projectEntities[ "planta_tparam_tipo_nombramiento" ] = array( "url" => "planta_tparam_tipo_nombramiento", "type" => 0 );
	$projectEntitiesReverse[ "planta_tparam_tipo_nombramiento" ] = "planta_tparam_tipo_nombramiento";
	...
	$projectEntities[ "global_ejecucion_usos" ] = array( "url" => "global_ejecucion_usos", "type" => 0 );
	$projectEntitiesReverse[ "global_ejecucion_usos" ] = "global_ejecucion_usos";
	...
	$projectEntities[ "paa_master_send" ] = array( "url" => "paa_master_send", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_send" ] = "paa_master_send";
	...
	$projectEntities[ "paa_master_usos_admin" ] = array( "url" => "paa_master_usos_admin", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_usos_admin" ] = "paa_master_usos_admin";
	$projectEntities[ "paa_master_no_paa_admin" ] = array( "url" => "paa_master_no_paa_admin", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_no_paa_admin" ] = "paa_master_no_paa_admin";
	$projectEntities[ "paa_master_pscdp" ] = array( "url" => "paa_master_pscdp", "type" => 0 );
	$projectEntitiesReverse[ "paa_master_pscdp" ] = "paa_master_pscdp";
	...
	$projectEntities[ "paa_master_pscdp_admin" ] = array( "url" => "paa_master_pscdp_admin", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_pscdp_admin" ] = "paa_master_pscdp_admin";
	...
	$projectEntities[ "paa_master_pscdp_admin_nopaa" ] = array( "url" => "paa_master_pscdp_admin_nopaa", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_pscdp_admin_nopaa" ] = "paa_master_pscdp_admin_nopaa";
	...
	$projectEntities[ "paa_master_modifica_adm" ] = array( "url" => "paa_master_modifica_adm", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_modifica_adm" ] = "paa_master_modifica_adm";
	$projectEntities[ "paa_master_view" ] = array( "url" => "paa_master_view", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_view" ] = "paa_master_view";
	...
	$projectEntities[ "paa_master_q" ] = array( "url" => "paa_master_q", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_q" ] = "paa_master_q";
	$projectEntities[ "paa_master_usos_q" ] = array( "url" => "paa_master_usos_q", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_usos_q" ] = "paa_master_usos_q";
	$projectEntities[ "paa_master_pscdp_q" ] = array( "url" => "paa_master_pscdp_q", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_pscdp_q" ] = "paa_master_pscdp_q";
	$projectEntities[ "paa_master_modifica_q" ] = array( "url" => "paa_master_modifica_q", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_modifica_q" ] = "paa_master_modifica_q";
	$projectEntities[ "paa_master_pscdp_nopaa" ] = array( "url" => "paa_master_pscdp_nopaa", "type" => 1 );
	$projectEntitiesReverse[ "paa_master_pscdp_nopaa" ] = "paa_master_pscdp_nopaa";
	$projectEntities[ "paa_master_ct" ] = array( "url" => "paa_master_ct", "type" => 0 );
	$projectEntitiesReverse[ "paa_master_ct" ] = "paa_master_ct";
	...
	$projectEntities[ "q_list_uej" ] = array( "url" => "q_list_uej", "type" => 0 );
	$projectEntitiesReverse[ "q_list_uej" ] = "q_list_uej";
}
