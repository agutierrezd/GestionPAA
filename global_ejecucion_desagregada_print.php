...
require_once("include/global_ejecucion_desagregada_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "global_ejecucion_desagregada" );
