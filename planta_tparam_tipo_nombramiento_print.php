...
require_once("include/planta_tparam_tipo_nombramiento_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "planta_tparam_tipo_nombramiento" );
