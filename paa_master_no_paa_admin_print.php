...
require_once("include/paa_master_no_paa_admin_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "paa_master_no_paa_admin" );
