...
$tdataq_divipola[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdataq_divipola[".originalPagesByType"] = $tdataq_divipola[".pagesByType"];
$tdataq_divipola[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdataq_divipola[".originalPages"] = $tdataq_divipola[".pages"];
$tdataq_divipola[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
...
$tdataq_divipola[".popupPagesLayoutNames"] = $popupPagesLayoutNames;
...
$tdataq_divipola[".rowHighlite"] = true;
...
$tdataq_divipola[".badgeColor"] = "7B68EE";
...
$tableEvents["q_divipola"] = new eventsBase;
