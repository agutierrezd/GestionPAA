...
'label' => array( 'text' => '<div align="left" class="alert alert-warning">
                      Haga clic en la opción <strong>Seleccionar</strong> y en la ventana de búsqueda escriba el nombre del contratista o el número de contrato para vincularlo al Plan Anual de Adquisiones. </br> Recuerde que si no realiza la vinculación del contrato al PAA no se le permitirá realizar los informes de supervisión
</div>',
'type' => 0 ) ) ),
'dbProps' => array(  ),
'version' => 4 );
