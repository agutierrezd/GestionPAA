...
function checkTableName($shortTName, $type=false)
{
	...
	if ("global_users" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_unspsc" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_meses" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_duracion" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_modalidad" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_fuenterec" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_vf" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_estvf" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_ubicacion" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master_no_paa" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_usos" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tparam_fuente" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("q_group_rec" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("global_ejecucion_desagregada" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_vigencia" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("dependencia" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("funcionario" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_estado" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tparam_vigencia" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("cargo" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("planta_tparam_tipo_nombramiento" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tipo_banco" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tipo_cta_banco" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("contrato" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_ejecucion_usos" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("global_ejecucion" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master_send" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	...
	if ("tparam_tiporubro" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_paa_nopaa" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master_admin" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_usos_admin" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_no_paa_admin" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_pscdp" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("global_operacion" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master_pscdp_admin" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("global_estado_scdp" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master_pscdp_admin_nopaa" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_modifica" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master_modifica_adm" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_view" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("global_estado_mod" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paa_master_q" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_usos_q" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_pscdp_q" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_modifica_q" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_pscdp_nopaa" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("paa_master_ct" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("admin_users" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("q_list_uej" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_unspsc");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_meses");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_modalidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_modalidad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_fuenterec");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_fuenterec";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_vf");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_estvf");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_ubicacion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_ubicacion";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_no_paa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_no_paa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_usos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_fuente");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_group_rec");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_vigencia");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_estado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_vigencia");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("planta_tparam_tipo_nombramiento");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="planta_tparam_tipo_nombramiento";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_ejecucion_usos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_ejecucion_usos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_send");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_paa_nopaa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_paa_nopaa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_admin");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_admin";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_usos_admin");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_usos_admin";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_no_paa_admin");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_no_paa_admin";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_operacion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_operacion";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_admin");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_admin";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_estado_scdp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_estado_scdp";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_admin_nopaa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_admin_nopaa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_modifica");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_modifica";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_modifica_adm");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_modifica_adm";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_estado_mod");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="global_estado_mod";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_q");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_usos_q");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_usos_q";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_q");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_q";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_modifica_q");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_modifica_q";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_pscdp_nopaa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="paa_master_pscdp_nopaa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("paa_master_ct");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_list_uej");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
function ReadUserPermissions($userID = "")
{
	...
	if($userID != "Guest")
	{
		...
		$sql = "select ".$gConn->addFieldWrappers( "GroupID" )
			...
			." from ". $gConn->addTableWrappers( "gestionpaa_ver_103_ugmembers" )
	...
	$sql = "select ". $gConn->addFieldWrappers( "TableName" )
		...
		." from ". $gConn->addTableWrappers( "gestionpaa_ver_103_ugrights" )
...
//	default permissions
	...
	if( $table=="global_modalidad" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_fuenterec" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="global_estvf" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_ubicacion" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_no_paa" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_usos" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_fuente" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_group_rec" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="planta_tparam_tipo_nombramiento" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="global_ejecucion_usos" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="global_paa_nopaa" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_admin" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_usos_admin" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_no_paa_admin" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_operacion" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_admin" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_estado_scdp" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_admin_nopaa" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_modifica" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_modifica_adm" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_view" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_estado_mod" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_q" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_usos_q" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_q" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_modifica_q" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_pscdp_nopaa" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
	}
	if( $table=="paa_master_ct" )
	{
//	default permissions
		// grant all by default
		return "ADESPI".$extraPerm;
...
function SetAuthSessionData($pUsername, &$data, $password, &$pageObject = null, $fireEvents = true )
{
	...
	if( Security::permissionsAvailable() ) {
		...
		$_SESSION["OwnerID"] = $data["idusrglobal"];
	$_SESSION["_paa_master_OwnerID"] = $data["idusrglobal"];
		$_SESSION["_paa_master_no_paa_OwnerID"] = $data["idusrglobal"];
		$_SESSION["_paa_master_send_OwnerID"] = $data["idusrglobal"];
		$_SESSION["_paa_master_admin_OwnerID"] = $data["idusrglobal"];
		$_SESSION["_paa_master_no_paa_admin_OwnerID"] = $data["idusrglobal"];
		$_SESSION["_paa_master_view_OwnerID"] = $data["idusrglobal"];
		$_SESSION["_paa_master_q_OwnerID"] = $data["idusrglobal"];
...
{
	$result = "";
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/loadfirst.js?34656")."\"></script>";
	$result .= $additionalScripts;
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/lang/".getLangFileName(mlang_getcurrentlang()).".js?34656")."\"></script>";
