...
$tdatapaa_master_modifica[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatapaa_master_modifica[".originalPagesByType"] = $tdatapaa_master_modifica[".pagesByType"];
$tdatapaa_master_modifica[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatapaa_master_modifica[".originalPages"] = $tdatapaa_master_modifica[".pages"];
$tdatapaa_master_modifica[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelspaa_master_modifica["Spanish"]["PAAM_ID"] = "TRANSACCIÓN";
...
$tdatapaa_master_modifica[".popupPagesLayoutNames"] = $popupPagesLayoutNames;
...
$tdatapaa_master_modifica[".listAjax"] = false;
	...
	$tdatapaa_master_modifica[".audit"] = false;

	$tdatapaa_master_modifica[".locking"] = false;
...
$tdatapaa_master_modifica[".rowHighlite"] = true;
...
$tdatapaa_master_modifica[".badgeColor"] = "4682b4";
...
$tdatapaa_master_modifica[".sqlHead"] = "SELECT PAAM_ID, PAA_ID_FK, PAAM_FECHA, PAA_MODIFICA, SYSUSER, MAIL_NOT, PAAM_ST";
...
$proto21["m_srcTableName"] = "paa_master_modifica";
...
$tableEvents["paa_master_modifica"] = new eventsBase;
$tdatapaa_master_modifica[".hasEvents"] = false;
