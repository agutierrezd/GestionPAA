...
$tdatadependencias_001[".pagesByType"] = my_json_decode( "{}" );
$tdatadependencias_001[".originalPagesByType"] = $tdatadependencias_001[".pagesByType"];
$tdatadependencias_001[".pages"] = types2pages( my_json_decode( "{}" ) );
$tdatadependencias_001[".originalPages"] = $tdatadependencias_001[".pages"];
$tdatadependencias_001[".defaultPages"] = my_json_decode( "{}" );
...
$tdatadependencias_001[".popupPagesLayoutNames"] = $popupPagesLayoutNames;
...
$tdatadependencias_001[".listAjax"] = false;
	...
	$tdatadependencias_001[".audit"] = false;

	$tdatadependencias_001[".locking"] = false;
...
$tdatadependencias_001[".badgeColor"] = "EDCA00";
...
$tdatadependencias_001[".sqlHead"] = "SELECT id_depto_superior,  	Departamento_superior";
...
$proto11["m_srcTableName"] = "dependencias_001";
...
$tableEvents["dependencias_001"] = new eventsBase;
