...
{
	$value = "";
				if($table=="paa_master_pscdp_admin" && $field=="DOCUMENTO_SCDP_SIIF")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_admin_nopaa" && $field=="DOCUMENTO_SCDP_SIIF")
	{
		;
		return $value;
	}
				if($table=="paa_master_pscdp_q" && $field=="DOCUMENTO_SCDP_SIIF")
	{
		;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
		if($table=="paa_master" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="paa_master_no_paa" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="paa_master_send" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="paa_master_send" && $field=="sys_status")
	{
		$strWhere = " ctrl_a = 1";
		return $strWhere;
	}
		if($table=="paa_master_admin" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="paa_master_no_paa_admin" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="paa_master_pscdp" && $field=="SYS_STATUS")
	{
		$strWhere = " status_scdp_id = 0";
		return $strWhere;
	}
		if($table=="paa_master_modifica" && $field=="PAAM_ST")
	{
		$strWhere = " status_mod_id = 0";
		return $strWhere;
	}
		if($table=="paa_master_view" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="paa_master_q" && $field=="vigencia")
	{
		$strWhere = " vigencia_st = 1";
		return $strWhere;
	}
		if($table=="paa_master_pscdp_q" && $field=="SYS_STATUS")
	{
		$strWhere = " status_scdp_id = 0";
		return $strWhere;
	}
		if($table=="paa_master_modifica_q" && $field=="PAAM_ST")
	{
		$strWhere = " status_mod_id = 0";
		return $strWhere;
	}
		if($table=="paa_master_pscdp_nopaa" && $field=="SYS_STATUS")
	{
		$strWhere = " status_scdp_id = 0";
		return $strWhere;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="paa_master" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master" && $field=="COD_UBICACION")
	{
		return CO-DC-11001;
	}
				if($table=="paa_master" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master" && $field=="sys_user")
	{
		return $_SESSION["UID"];
	}
				if($table=="paa_master" && $field=="sys_status")
	{
		return 0;
	}
				if($table=="paa_master" && $field=="TIPOSOL")
	{
		return 1;
	}
				if($table=="paa_master_no_paa" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master_no_paa" && $field=="COD_UBICACION")
	{
		return CO-DC-11001;
	}
				if($table=="paa_master_no_paa" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_no_paa" && $field=="sys_user")
	{
		return $_SESSION["UID"];
	}
				if($table=="paa_master_no_paa" && $field=="sys_status")
	{
		return 0;
	}
				if($table=="paa_master_no_paa" && $field=="TIPOSOL")
	{
		return 2;
	}
				if($table=="paa_master_usos" && $field=="FECHA_REG")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_usos" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_usos" && $field=="SYS_STATUS")
	{
		return 0;
	}
				if($table=="contractor_master" && $field=="active")
	{
		return 1;
				...
				if($table=="paa_master_send" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master_send" && $field=="COD_UBICACION")
	{
		return CO-DC-11001;
	}
				if($table=="paa_master_send" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_send" && $field=="sys_user")
	{
		return $_SESSION["UID"];
	}
				if($table=="paa_master_send" && $field=="TIPOSOL")
	{
		return 1;
	}
				if($table=="paa_master_admin" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master_admin" && $field=="COD_UBICACION")
	{
		return CO-DC-11001;
	}
				if($table=="paa_master_admin" && $field=="TIPOSOL")
	{
		return 1;
	}
				if($table=="paa_master_usos_admin" && $field=="FECHA_REG")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_usos_admin" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_no_paa_admin" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master_no_paa_admin" && $field=="COD_UBICACION")
	{
		return CO-DC-11001;
	}
				if($table=="paa_master_no_paa_admin" && $field=="TIPOSOL")
	{
		return 2;
	}
				if($table=="paa_master_pscdp" && $field=="SOL_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp" && $field=="SYS_STATUS")
	{
		return 0;
				...
				if($table=="paa_master_pscdp_admin" && $field=="FECHA_SCDP_SIIF")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_admin" && $field=="USUARIO_SCDP_SIIF")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_admin" && $field=="DEV_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_admin" && $field=="DEV_USER")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_admin_nopaa" && $field=="FECHA_SCDP_SIIF")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_admin_nopaa" && $field=="USUARIO_SCDP_SIIF")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_admin_nopaa" && $field=="DEV_USER")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_modifica" && $field=="PAAM_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_modifica" && $field=="SYSUSER")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_modifica_adm" && $field=="PAAM_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_modifica_adm" && $field=="SYS_USER")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_modifica_adm" && $field=="SYS_DATE")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_view" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master_view" && $field=="COD_UBICACION")
	{
		return CO-DC-11001;
	}
				if($table=="paa_master_view" && $field=="responsable")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_view" && $field=="sys_user")
	{
		return $_SESSION["UID"];
	}
				if($table=="paa_master_view" && $field=="sys_status")
	{
		return 0;
	}
				if($table=="paa_master_view" && $field=="TIPOSOL")
	{
		return 1;
	}
				if($table=="paa_master_q" && $field=="UNIDAD_CONTRATACION")
	{
		return PAA;
	}
				if($table=="paa_master_q" && $field=="COD_UBICACION")
	{
		return CO-DC-11001;
	}
				if($table=="paa_master_q" && $field=="TIPOSOL")
	{
		return 1;
	}
				if($table=="paa_master_usos_q" && $field=="FECHA_REG")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_usos_q" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_q" && $field=="SOL_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_q" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_q" && $field=="SYS_STATUS")
	{
		return 0;
				...
				if($table=="paa_master_modifica_q" && $field=="PAAM_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_modifica_q" && $field=="SYSUSER")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_nopaa" && $field=="SOL_FECHA")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="paa_master_pscdp_nopaa" && $field=="USER_REG")
	{
		return $_SESSION["UserID"];
	}
				if($table=="paa_master_pscdp_nopaa" && $field=="SYS_STATUS")
