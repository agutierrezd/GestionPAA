...
require_once("include/global_ejecucion_actividades_spi_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "global_ejecucion_actividades_spi" );
